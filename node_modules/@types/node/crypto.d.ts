...
declare module "crypto" {
    ...
    class Certificate {
         ...
         * const quest = Certificate.exportQuest(spkac);
         * console.log(quest.toString('utf8'));
         * // Prints: the quest as a UTF8 string
         * ```
         * @since v9.0.0
         * @param encoding The `encoding` of the `spkac` string.
         * @return The quest component of the `spkac` data structure, which includes a public key and a quest.
         */
        static exportQuest(spkac: BinaryLike): Buffer;
        /**
         * ```js
         * const { Certificate } = await import('node:crypto');
         * const spkac = getSpkacSomehow();
         ...
         * @since v9.0.0
         * @param encoding The `encoding` of the `spkac` string.
         * @return The public key component of the `spkac` data structure, which includes a public key and a quest.
         */
         ...
         * @deprecated
         * @param spkac
         * @returns The quest component of the `spkac` data structure,
         * which includes a public key and a quest.
         */
        exportQuest(spkac: BinaryLike): Buffer;
        /**
         * @deprecated
         * @param spkac
         * @param encoding The encoding of the spkac string.
